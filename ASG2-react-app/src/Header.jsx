...
function Header(props) 
{
    ...
    return(
        <div className=' flex  justify-around items-center w-auto h-fit gap-20 my-5 mx-5 py-2 px-2 border-solid border-2 border-#067BC2 bg-jYellow shadow-md rounded-md size-20 '>
            <div>
                <img src='/ZSlogo.png' className='size-' alt='LOGO'/>
            </div>
            <div className='place-items-center'>
                <p className='text-4xl mt-4 text-bold text-white'>Collection of Galleries and their Artwork</p>
            </div >
                ...
                <Modal title={"Favourites"} open={openResponsive} onOk={()=>setOpenResponsive(false)} onCancel={()=>setOpenResponsive(false) } width={'80%'}
                   >
                    <FavouritesModalInfo/>
                </Modal>
